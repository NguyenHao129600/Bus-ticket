...
const RouteModel = {
  getAll: async ({ page = 1, limit = 10, operator_id, departure_station_id, arrival_station_id } = {}) => {
    ...
    const [countRows] = await db.query(`SELECT COUNT(*) AS total FROM routes r ${where}`, params);
